...
wget -c -O /opt/etc/init.d/S95transmission http://goo.gl/cSA0os
...
wget -c -O /opt/etc/transmission-daemon/settings.json http://goo.gl/6PUFUC
...
```
wget -c -O /jffs/scripts/firewall-start http://goo.gl/owdjyq
