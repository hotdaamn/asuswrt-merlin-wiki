THIS WIKI IS NOT FINISHED. IF YOU UNDERSTAND THE SCRIPT AND WOULD LIKE TO USE IT THEN FEEL FREE. THANKS.
...
==Implementing
This script is all contained in one file. There are several ways you can do this. You can copy the contents into the services-start script in jffs or you can create a new file and make it executable. In the services-start script, simply point to that file so that it can be executed.
